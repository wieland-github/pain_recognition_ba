...
def loso_binary_calibrated_nested_cv(X, y, groups, model, space, k, balance=False):
    """
...
def loso_binary_fully_personalized_nested_cv(X, y, groups, model, space, model_type):
    """
    ...
    for subject in np.unique(groups):
        ...
        for train_idx, test_idx in outer_cv.split(X_subject, y_subject):
...
def loso_binary_nested_cv_with_group_importance(X, y, groups, model, space, model_type, signal_groups, n_repeats=10, random_state=RANDOM_STATE, scoring=None):
    """
